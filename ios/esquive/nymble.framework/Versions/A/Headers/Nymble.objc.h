...
@interface Nymble : NSObject
+ (NSString* _Nonnull) hostIP;
+ (void) setHostIP:(NSString* _Nonnull)v;
 ...
 * noinspection GoUnusedExportedFunction
 */
FOUNDATION_EXPORT BOOL NymbleTestDebugServer(NSError* _Nullable* _Nullable error);
